...
const {REACT_APP_BACKEND_URL} = process.env
 ...
 class EditBlogPost extends Component {
  ...
  componentDidMount = () => {
    ...
    const author = this.props.authors.find(author => author.id === blog.author)
...
/*     let formData = new FormData()
    ...
    try {
      const authorId = this.props.authors.find(author => author.name.includes(this.state.blog.author.split(' ')[0])).id
